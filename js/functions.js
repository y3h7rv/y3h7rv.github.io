...
$(document).ready(function() {
    setTimeout(function() {
        console.log("Delayed binding");
        // // 使用事件委托绑定蝙蝠点击事件
    $('.bat').bind('click', '.bat', function() {
        console.log("bat clicked!"); // 确认事件是否被触发
        const bat = $(this);
        bat.css({
    ...
    $('.ghost').bind('click', function() {
        ...
        const ghost = $(this);
        ghost.fadeOut(300).fadeIn(300);
    });
        
    }, 500); // 延迟500ms，等待DOM渲染完成
